...
<!--nav end=============================================-->
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow dark bg-fixed text-center text-light" style="background-image: url(assets/img/humidifier.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="humidifiers.php">Humidifiers</a></li>
