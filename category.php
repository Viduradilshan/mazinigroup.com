            ...
            <div class="blog-items">
                <div class="blog-content col-md-8">
                    ...
                    if (mysqli_num_rows($select_cat_run) > 0) {
                        ...
                        $post_get = "SELECT * FROM `post` WHERE cat_name='$cat_ids' AND country='all' LIMIT $offset, $items_per_page";
                    ...
                    <?php
                    $slug = mysqli_real_escape_string($mysql, $_GET['title']);
                    $select_count = "SELECT COUNT(*) AS total FROM `post` WHERE cat_name='$cat_ids' AND country='all'";
                                ...
                                <nav aria-label="navigation">
                                    <ul class="pagination">
                                        <?php if ($current_page > 1) { ?>
                                            <li><a href="category.php?title=<?= $slug ?>&page=<?= $current_page - 1 ?>">Previous</a></li>
                                        <?php } ?>
                                        <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                            <li class="<?= ($i === $current_page) ? 'active' : '' ?>"><a href="category.php?title=<?= $slug ?>&page=<?= $i ?>"><?= $i ?></a></li>
                                        <?php } ?>
                                        <?php if ($current_page < $total_pages) { ?>
                                            <li><a href="category.php?title=<?= $slug ?>&page=<?= $current_page + 1 ?>">Next</a></li>
                                        <?php } ?>
                                    </ul>
                                </nav>
                            </div>
