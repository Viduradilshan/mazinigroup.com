        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 contact-form">
                    <div class="form-box">
                        <h2>¡Realiza un pedido ahora mismo!</h2>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group comments">
                                        <textarea class="form-control" id="comments" name="comments" placeholder="Ingrese un mensaje o realice un pedido*"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <button type="submit" name="oder" id="submit">
