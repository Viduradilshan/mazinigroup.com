                                                ...
                                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                                           <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <small id="TitleHelp" class="form-text text-muted">add category name.</small>
                                                                </div>
                                                            </div>
                                                            <div class="row ">
                                                                <div class="col-md-10 mb-4">
                                                                
                                                                <button type="submit" name="post-add" class=" btn btn-secondary btn-lg">Add Category</button>
                                                                </div>
                                                            </div>
                                                </form>
                                    </div>
